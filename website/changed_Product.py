...
# changes_to = Blueprint('changes_to', __name__)


# @changes_to.route('/', methods=['POST', 'GET'])
# def home():
...
# @changes_to.route('/delete/<int:id>')
# def delete(id):
...
# @changes_to.route('/update/<int:id>', methods=['GET', 'POST'])
# def update(id):
...
#         product.date_updated = db.func.now()
